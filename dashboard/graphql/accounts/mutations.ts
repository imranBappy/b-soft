...
export const ADDRESS_MUTATION = gql`
 mutation MyMutation($address: String, $area: String, $city: String, $country: String, $house: String, $id: String, $state: String, $street: String, $user: ID, $addressType: String!, $default: Boolean!) {
  addressCud(
    input: {address: $address, area: $area, city: $city, country: $country, house: $house, id: $id, state: $state, street: $street, user: $user, addressType: $addressType, default: $default}
  ) {
    success
    address {
      id
