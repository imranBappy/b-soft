...
const Navbar = () => {
    ...
    return (
        <div className="navbar border-b h-[80px]   bg-gray-deep  relative    ">
            <div className="container">
                <div className="navbar-wrap h-[80px]  flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Button
                            className=" md:hidden px-3  font-playfair text-base"
                            variant={'secondary'}
                        >
                            <Link
                                href={'/shop'}
                        ...
                        <Button
                            className=" hidden md:block   font-playfair  text-white  px-3 text-base"
                            variant={'ghost'}
                        >
                            <Link
                                className="flex items-center gap-2"
            ...
            <div
                className={`w-full px-5 py-3 absolute  ${
                    isOpenMenu ? 'block' : 'hidden'
                } md:hidden !z-50 bg-black`}
            >
                <ul className="flex flex-col gap-1 !z-50">
                    ...
                    <li
                        ...
                        className="flex py-2 items-center gap-2 text-white font-playfair text-base hover:text-gray-400 border-b border-gray-400 "
                    >
                        <Link href="/blog">Blog</Link> {/* Add this line */}
                    </li>
                    <li
                        onClick={() => setIsOpenMenu(!isOpenMenu)}
                        className="flex py-2 items-center gap-2 text-white font-playfair text-base hover:text-gray-400 border-b border-gray-400 "
            ...
            <div
                className={`overlay ${isOpenMenu ? 'open' : ''}`}
                onClick={() => setIsOpenMenu(!isOpenMenu)}
            ></div>
        </div>
    );
